...
const SECTIONS: { title: string; body: string }[] = [
  ...
  },
  {
    ...
    body: "تطبّق حدود دنيا على الكميات: 20 كيلوجرامًا كحد أدنى لكل صنف في الطلبات بالوزن، و50 قطعة كحد أدنى لكل صنف في الطلبات بالعدد. قد يتم رفض الطلبات التي لا تستوفي هذه الحدود.",
  },
  {
    title: "الدفع",
